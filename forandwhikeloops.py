...
#Write a program that generates a random number between 1 and 50, and asks the user to guess it. 
# Continue asking until they guess correctly, providing feedback if their guess is too high or too low.
...
# Continuously ask the user to input numbers. Track the smallest and largest numbers entered, and stop the loop when the user types 'stop'. 
